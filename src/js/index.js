...
class Menu {
  ...
  // findSubmenuItemIndex(menuLinkIndex) {
  //   this.submenuItems.forEach((submenuItem, submenuItemIndex) => {
  //     if (menuLinkIndex == submenuItemIndex) {
  //       return menuLinkIndex;
  //     }
  //   });
  // }
  ...
  itemsToggling() {
    this.menuLinks.forEach((menuLink, menuLinkIndex) => {
      menuLink.addEventListener("mouseenter", (e) => {
        ...
        // this.submenuItems.forEach((submenuItem, submenuItemIndex) => {
        //   if (menuLinkIndex == submenuItemIndex) {
        //     submenuItem.classList.add("header__catalog__items_active");
        //   }
        // });
      });
    });
